...
export default function Signup() {
  ...
  return (
    <div className="flex flex-col w-full h-screen justify-center items-center">
      ...
      <form
        onSubmit={signUser}
        className="flex flex-col w-[600px] gap-7 items-center"
      >
        ...
        />
        <button
          className="flex flex-col items-center justify-center cursor-pointer mb-7 w-2/6 bg-black h-9 rounded-md text-white"
          type="submit"
        >
          Signup
        </button>
      </form>
      <span classNme="text-base">
